// Revisión 051 - Basado en rev. 034 con tiempos 4/2, marcas azul-verde-amarilla y movimiento suave
...
function actualizarMovimientoPelota(offsetRejaX = 0, offsetRejaY = 0) {
  ...
  if (faseActual === "visible") {
    ...
    if (puntoDestinoCubierto) {
      ...
      // 🟡 Marca amarilla: destino cubierto
...
// --- Fin del archivo pelota.js — 2025-05-01 21:10:20 GMT-3 — rev. 051 ---
